import mlflow
from multimodal.utils.errors import EvaluationError
from multimodal.core.llm import LLMClient

# Keep adapter + HF embeddings internal to Evaluator for Ragas compatibility
from multimodal.core.llm_adapter import LLMAdapter  # if you prefer, move this into core and import here
